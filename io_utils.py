...
def parse_args(mode):
    ...
    parser.add_argument('--ne', action='store_true', help='Use negative sample')
    ...
    parser.add_argument('--alpha', default=1e-4, type=float, help='Gamma value for {LS,US} + UT.')  # similar to aug_mode
    ...
    parser.add_argument('--pr', default=0.4, type=float,help="pruning rate")
    parser.add_argument('--fre', default=100, type=int, help="pruning rate")
